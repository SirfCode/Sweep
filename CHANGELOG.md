...
- Animated plays, captures, house assembly and sweep celebration.
...
- Complete offline partnership Sweep with one human and three bots.
- Opening call, captures, houses, commitments, sweeps and cumulative scoring.
